function [gly_crop, gly_inrange] = crop_candidates_hog(img_frame, curr_samples, template_size)
...
for n = 1:nsamples
    ...
    hog_img_cut= hogfeat(img_cut);
    
    [m1,n1]=size(hog_img_cut);
    a=[m1,n1];
    gly = reshape(hog_img_cut, max(a) , 1);
