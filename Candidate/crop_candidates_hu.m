function [gly_crop, gly_inrange] = crop_candidates_hu(img_frame, curr_samples, template_size)
...
for n = 1:nsamples
    ...
    hu_img_cut= M_GetImageHuJu(img_cut);
    %lbp_img_cut= hogfeat(img_cut);
    
    [m1,n1]=size(hu_img_cut);
    a=[m1,n1];
    gly = reshape(hu_img_cut, max(a) , 1);
