function [crop,crop_norm,crop_mean,crop_std,img_map] = corner2image_lbp(img, p, tsize)
...
%lbp_img_map= hogfeat(img_map);

[m1,n1]=size(lbp_img_map);
lbp_img_map=lbp_img_map';
a=[m1,n1];
crop= reshape(lbp_img_map,max(a), 1);
