function [crop,crop_norm,crop_mean,crop_std,img_map] = corner2image_hu(img, p, tsize)
...
hu_img_map= M_GetImageHuJu(img_map);

[m1,n1]=size(hu_img_map);
hu_img_map=hu_img_map';
a=[m1,n1];
crop= reshape(hu_img_map,max(a), 1);
